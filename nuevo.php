    ...
    <div class="contenidoformulario">
        <div id="formularioEnvio">
            ...
            <form action="controller/GuardaProducto.php" method="POST">
                ...
                <input class="form-control" type="text" placeholder="Ingresa el producto" name="producto" required/>
                <label>Cantidad</label>
                <input class="form-control" type="text" placeholder="Cuantos productos?" name="cantidad" required/>
